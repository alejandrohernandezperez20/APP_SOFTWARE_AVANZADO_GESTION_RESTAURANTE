	...
	<div class="container">
		...
		<div id="caja1">
			<h5>INVENTARIO CON FECHA: <%
			   ...
			   %></h5>
				<button type="button" class="boton_icon" style="float: right;margin-top:-5%;" onclick="window.location='bar.jsp'"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
